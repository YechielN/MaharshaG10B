...
!function(t) {
    ...
    function Ht(t) {
        ...
        for (e = 0; e < t.length; e++) {
            for (n = t[e],
            i = 0; i < r.length && It(n, r[i]).length; i++)
                ;
            n.level = i,
            (r[i] || (r[i] = [])).push(n)
        }
    ...
    function Bt(n, i) {
        ...
        _.moment = function() {
            var t;
            return "local" === _.options.timezone ? (t = Ot.moment.apply(null, arguments),
            t.hasTime() && t.local()) : t = "UTC" === _.options.timezone ? Ot.moment.utc.apply(null, arguments) : Ot.moment.parseZone.apply(null, arguments),
            r(t),
            t
        }
        ,
    ...
    t.fn.fullCalendar = function(e) {
        ...
        return this.each(function(r, s) {
            ...
            r || (i = o),
            "destroy" === e && l.removeData("fullCalendar")) : a || (a = new fe(l,e),
    ...
    qt.time = function(t) {
        if (!this._fullCalendar)
            return Zt.time.apply(this, arguments);
        if (null == t)
            return e.duration({
                hours: this.hours(),
    ...
    ,
    qt.local = function(t) {
        return Zt.local.call(this, this._ambigZone || t),
        this._ambigTime = !1,
        this._ambigZone = !1,
        this
    }
    ...
    function() {
        ...
        function n(t, e, n, s, o) {
            var l;
            return t = Ot.moment.parseZone(t),
        ...
        function i(t, e, n, i, r) {
            var s, o, l, a = t.sameUnits, u = e.clone().stripZone(), c = n.clone().stripZone(), f = d(t.fakeFormatString, e), g = d(t.fakeFormatString, n), p = "", v = "", m = "", y = "", S = "";
        ...
        function o(t) {
            for (var e, n = [], i = /\[([^\]]*)\]|\(([^\)]*)\)|(LTS|LT|(\w)\4*o?)|([^\w\[\(]+)/g; e = i.exec(t); )
                e[1] ? n.push.apply(n, l(e[1])) : e[2] ? n.push({
                    maybe: o(e[2])
                }) : e[3] ? n.push({
                    token: e[3]
        ...
        function a(t) {
            ...
            for (e = 0; e < t.length; e++)
                n = t[e],
                "string" == typeof n ? i.push("[" + n + "]") : n.token ? n.token in y ? i.push(p + "[" + n.token + "]") : i.push(n.token) : n.maybe && i.push(v + a(n.maybe) + v);
            return i.join(g)
        }
        function u(t) {
            var e, n, i, r = [];
    ...
    var oe = ct.extend(te, {
      ...
      , le = Ot.Grid = ct.extend(te, {
        ...
        dayMousedown: function(t) {
            var e = this.view;
            e.isSelected || e.selectedEvent || (this.dayClickListener.startInteraction(t),
        ...
        buildDaySelectListener: function() {
            var t, e = this, n = this.view, i = new re(this,{
                ...
                hitOver: function(n, i, r) {
                    r && (t = e.computeSelection(e.getHitSpan(r), e.getHitSpan(n)),
    ...
    le.mixin({
        ...
        handleSegMouseover: function(t, e) {
            se.get().shouldIgnoreMouse() || this.mousedOverSeg || (this.mousedOverSeg = t,
            ...
            var d = this.segDragListener = new re(l,{
                ...
                interactionEnd: function(s) {
                    ...
                    n.stop(!i, function() {
                        e && (l.unrenderDrag(),
                        r.segDragStop(t, s)),
                        i ? l.reportSegDrop(t, i, r.largeUnit, u, s) : l.showEvent(c)
                    }),
        ...
        computeEventDrop: function(t, e, n) {
            ...
            s.normalizeEventTimes(r)) : r = mt(n),
            r.start.add(i),
            r.end && r.end.add(i)) : r = {
                start: l.clone(),
                end: null,
        ...
        buildSegResizeListener: function(t, e) {
            var n, i, r = this, l = this.view, a = l.calendar, u = t.el, c = t.event, d = a.getEventEnd(c), h = this.segResizeListener = new re(this,{
                scroll: l.opt("dragScroll"),
                subjectEl: u,
                interactionStart: function() {
                    n = !1
                ...
                interactionEnd: function(e) {
                    ...
                    i ? l.reportSegResize(t, i, r.largeUnit, u, e) : l.showEvent(c),
    ...
    var de = Ot.View = ct.extend(Jt, te, {
        ...
        constructor: function(t, n, i, r) {
            ...
            this.eventRenderQueue = new gt(this.opt("eventRenderWait")),
            this.initialize()
        },
        initialize: function() {},
        opt: function(t) {
        ...
        computeTitle: function() {
            ...
            e = this.intervalEnd) : (t = this.start,
            e = this.end),
            this.formatRange({
    ...
    var fe = Ot.Calendar = ct.extend({
        ...
        populateOptionsHash: function() {
            ...
            e = ge[t],
            e || (t = fe.defaults.locale,
            e = ge[t] || {}),
            i = J(this.dynamicOverrides.isRTL, this.overrides.isRTL, e.isRTL, fe.defaults.isRTL),
            r = i ? fe.rtlDefaults : {},
            this.dirDefaults = r,
            this.localeDefaults = e,
            this.options = n([fe.defaults, r, e, this.overrides, this.dynamicOverrides]),
            Nt(this.options)
        },
        ...
        buildViewSpecOptions: function(t) {
            t.options = n([fe.defaults, t.defaults, this.dirDefaults, this.localeDefaults, this.overrides, t.overrides, this.dynamicOverrides]),
            Nt(t.options)
        },
        buildViewSpecButtonText: function(t, e) {
            ...
            t.buttonTextDefault = n(this.localeDefaults) || n(this.dirDefaults) || t.defaults.buttonText || n(fe.defaults) || (t.duration ? this.humanizeDuration(t.duration) : null) || e
        },
